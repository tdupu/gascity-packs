Use Superpowers plan writing to create the implementation plan at
`{{plan_path}}`. Preserve the requirements artifact and keep external
publication out of this methodology step.
