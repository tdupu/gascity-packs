Translate `{{plan_path}}` and optional context `{{context_path}}` into BMAD
epics and stories. Record `{{decomposition_path}}` if the caller supplied a
decomposition artifact path.
