...
FORMULA="$REPO_ROOT/mathcity/formulas/brief-shuffle.toml"
CHECK_SH="$REPO_ROOT/mathcity/assets/scripts/checks/brief-check.sh"
STAGING_CLEAR_SH="$REPO_ROOT/mathcity/assets/scripts/checks/brief-staging-clear.sh"
