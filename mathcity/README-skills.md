...
### Pack development / hygiene — `subdomains/dev/skills/`  (10)
...
| `check-zfc` | `mathcity-dev.check-zfc` | ZFC (Zero-Framework-Cognition) compliance checker — scans a skill, formula, or pipeline artifact and flags every place a framework makes a reasoning decision that should be a model call. |
